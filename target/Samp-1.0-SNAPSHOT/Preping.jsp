    ...
    <body>
        ...
        <div class="all-title-box">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2>Now Preparing <i class="fas fa-cookie-bite fa-spin"></i></h2>
                        <ul class="breadcrumb">
        ...
        <!-- End All Title Box -->
        <%
            JustO newO = (JustO) session.getAttribute("marootodo");
        %>
        <!-- Start Cart  -->
        <div class="cart-box-main">
            <div class="container">
                ...
                <div class="row my-5">
                    ...
                    <div class="col-12 d-flex shopping-box"> <a href="completed" class="ml-auto btn hvr-hover">Order Completed</a> </div>
                </div>
